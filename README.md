...
🔸 HTML – Fundamentos da estruturação de páginas

🔸 CSS – Layout, responsividade e boas práticas de estilização

🔸 JavaScript – Lógica de programação e interatividade

🔸 Python – Automação, lógica e integração com banco de dados

🔸 SQL – Criação, manipulação e modelagem de bancos de dados (especialmente PostgreSQL)
